...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('resg_solicitudes_resguardo', function (Blueprint $table) {
            $table->integer('id_solicitud_resguardo')->unsigned();
            $table->primary('id_solicitud_resguardo');
    ...
    {
        Schema::dropIfExists('resg_solicitudes_resguardo');
    }
};
