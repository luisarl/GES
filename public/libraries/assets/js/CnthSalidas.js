...
function CargarTabla()
{
    ...
    if( cantidad <= 0 || parseFloat(cantidad) > parseFloat(existencia) ) //valida si la cantidad ingresada es mayor al stock o menor a cero
    {
    ...
    else 
        {
            ...
            $("#tablaajuste>tbody").append("<tr><td id='id_herramienta'>"+herramienta.split('-')[0]+"</td><td id='nombre_herramienta'>"+herramienta.split('-')[1]+"</td><td id='cantidad'>"+cantidad+"</td><th> <button type='button' class='borrar btn btn-danger btn-sm'><i class='fa fa-trash'></i></button> </th></tr>");
