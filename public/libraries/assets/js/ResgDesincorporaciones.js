...
function CargarTabla()
{
    ...
    if(IdResguardo  == 0 )
    {
        ...
        {
            $("#tablaarticulos>tbody").append("<tr><td id='id_solicitud_desincorporacion_detalle' style='visibility:collapse; display:none;'></td>"
...
function CapturarDatosTabla()
{
    ...
    document.querySelectorAll('#tablaarticulos tbody tr').forEach(function(e){
        let fila = {
            id_solicitud_desincorporacion_detalle: e.querySelector('#id_solicitud_desincorporacion_detalle').innerText,
...
function CapturarDatosTablaDesincorporacion()
{
    let lista_articulos = [];
    ...
    console.log(JSON.stringify(lista_articulos));
    $('#articulos_desincorporacion').val(JSON.stringify(lista_articulos)); //PASA DATOS DE LA TABLA A CAMPO OCULTO PARA ENVIAR POR POST
