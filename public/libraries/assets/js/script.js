...
//BLOQUEAR BOTON AL HACER SUBMIT
$(document).ready(function() {
    
    $('button[type="submit"]').click(function(event){

        event.preventDefault(); // Evita que el formulario se envíe automáticamente
        $(this).prop("disabled", true); // deshabilita el botón y previene un doble clic
        $(this).addClass('btn-disabled'); // agrega la clase btn-disabled
        $(this).text('Espere...'); // cambia el texto
    ...
    // // Captura la tecla presionada en el teclado
    // $(document).keydown(function (event) { 
    //     if (event.keyCode == 123) // si presiona F12
    //     { 
    //         return false;
    //     } 
    //     else if (event.ctrlKey && event.shiftKey && event.keyCode == 73) // si presiona Ctrl+Shift+I     
    //         {    
    //             return false;
    //         }
    //         else if(event.ctrlKey  && event.keyCode == 85) // si presiona Ctr+u
    //             { 
    //                 return false;
    //             }
    // });  
    
    // // Captura el boton presionado en el mouse
    // $(document).mousedown(function(e) { 
    //     if (e.which == 3) 
    //     {
    //        alert('Esta opción no está disponible'); // si presiona el click derecho del mouse
    //     }
    // });
});