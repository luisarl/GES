...
$(document).ready(function(){
    ...
    $('#filer_input_single').filer({
        ...
        captions: {
            ...
            feedback: "Selecciona la imagen",
            feedback2: "Archivos Seleccionados",
            drop: "Suelte el archivo aquí para cargar",
            removeConfirmation: "¿Estás seguro de que quieres eliminar este archivo?",
            errors: {
                filesLimit: "Solo se permite subir {{fi-limit}} archivos.",
                filesType: "Solo se pueden subir imágenes.",
                filesSize: "{{fi-name}} Es demasiado largo! Cargue el archivo hasta {{fi-maxSize}} MB.",
                filesSizeAll: "¡Los archivos que ha elegido son demasiado grandes! Cargue archivos hasta {{fi-maxSize}} MB."
            }
        }
    });
    ...
    $('#filer_input').filer({
        limit: 3,
        maxSize: 5,
        extensions: ['jpg', 'jpeg', 'png', 'gif', 'psd', 'pdf', 'xls', 'xlsx', 'doc', 'docx', 'ppt', 'pptx','dwg','dxf'],
        changeInput: true,
        showThumbs: true,
        addMore: true,
        ...
        captions: {
            ...
            feedback: "Selecciona el archivo",
            feedback2: "Archivos Seleccionados",
            drop: "Suelte el archivo aquí para cargar",
            removeConfirmation: "¿Estás seguro de que quieres eliminar este archivo?",
            errors: {
                filesLimit: "Solo se permite subir {{fi-limit}} archivos.",
                filesType: "El archivo seleccionado no es permitido.",
                filesSize: "{{fi-name}} Es demasiado largo! Cargue el archivo hasta {{fi-maxSize}} MB.",
                filesSizeAll: "¡Los archivos que ha elegido son demasiado grandes! Cargue archivos hasta {{fi-maxSize}} MB."
            }
        }
