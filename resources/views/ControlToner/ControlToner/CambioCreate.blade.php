...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{ url('#') }}">Control de Toner</a> </li>
    <li class="breadcrumb-item"><a href="{{ route('cnttcontroltoner.index') }}"></a> </li>
...
<div class="card">
    ...
    <div class="card-block">
        <form method="POST" action="{{ route('cnttcontroltoner.store') }}">
            @csrf
           
            <div class="form-group row">
                <label class="col-sm-2 form-label">Fecha de Cambio</label>
                <div class="col-sm-2">
                    <input type="date" name="fecha_cambio" id="fecha_cambio" class="form-control @error('fecha_cambio') is-invalid @enderror" value="{{ old('fecha_cambio') }}">    
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="date" name="fecha_ultimo_cambio" id="fecha_ultimo_cambio" class="form-control @error('fecha_ultimo_cambio') is-invalid @enderror" value="{{ old('fecha_ultimo_cambio') }}" >    
                </div>
                <label class="col-sm-2 form-label">Contador actual</label>
                <div class="col-sm-2">
                    <input type="number" name="cantidad_actual" id="cantidad_actual" class="form-control @error('cantidad_actual') is-invalid @enderror" value="{{ old('cantidad_actual') }}">
                </div>

                <label class="col-sm-1 form-label">Contador anterior</label>
                <div class="col-sm-2">
                    <input type="number" name="cantidad_anterior" id="cantidad_anterior" class="form-control @error('cantidad_anterior') is-invalid @enderror" value="{{ old('cantidad_anterior') }}" >
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <select name="servicio" id="servicio" class="js-example-basic-single form-control">
                        ...
                        <option value="RECARGA TONER">RECARGA TONER</option>
                        <option value="TONER NUEVO">TONER NUEVO</option>
                    </select>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-1">
                    <input type="number" name="cantidad_total" id="cantidad_total" class="form-control @error('cantidad_total') is-invalid @enderror" value="{{ old('cantidad_total') }}" readonly>
                </div>

                <label class="col-sm-2 form-label">Dias de duracion del toner</label>
                <div class="col-sm-1">
                    <input type="number" name="dias_total" id="dias_total" class="form-control @error('dias_total') is-invalid @enderror" value="{{ old('dias_total') }}"readonly>
                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('#activo').append('<option value="'+ value.id_activo +'">'+ value.nombre_activo +' - '+ value.ubicacion +'</option>');
                    });
                }
            });
        } else {
