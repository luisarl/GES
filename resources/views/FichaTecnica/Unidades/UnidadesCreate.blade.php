...
<div class="card">
    <div class="card-header">
        <h5>Crear Unid. de Medida</h5>

    </div>
    <div class="card-block">
        <h4 class="sub-title"></h4>
        <form class="" method="POST" action=" {{ route('unidades.store') }}">
            @csrf
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Abreviatura</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control form-control-uppercase @error('abreviatura_unidad') is-invalid @enderror" name="abreviatura_unidad"
                       value="{{ old('abreviatura_unidad') }}" placeholder="Ingrese la Abreviatura de la Unidad de Medida">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nombre_unidad') is-invalid @enderror" name="nombre_unidad"
                       value="{{ old('nombre_unidad') }}" placeholder="Ingrese el Nombre de la Unidad de Medida">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Clasificación</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('clasificacion_unidad') is-invalid @enderror" name="clasificacion_unidad"
                       value="{{ old('clasificacion_unidad') }}" placeholder="Ingrese la Clasificación de la Unidad de Medida">
                </div>
            </div>
            <hr>
