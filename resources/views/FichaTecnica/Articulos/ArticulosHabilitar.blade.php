<div class="modal fade" id="modal-habilitar" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if($articulo->estatus == 'MIGRADO')
                    <h5>Desea Habilitar El Articulo Para Su Modificación?</h5>
                ...
                @else
                    <h5>Desea Bloquear Nuevamente El Articulo?</h5>      
                @endif
            </div>
            <div class="modal-footer">
               <form method="GET" action=" {{ route('habilitar', $articulo->id_articulo) }}" >
                    @csrf
