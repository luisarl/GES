...
@include('FichaTecnica.Ubicaciones.UbicacionesDestroy')
    ...
    <div class="card">
        <div class="card-header">
            <h5>Listado de Zona</h5>
            @can('fict.ubicaciones.crear') 
                <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('ubicacionesarticulos.create') !!}">
                    ...
                    <tbody>
                        @foreach ($ubicaciones as $ubicacion)
                            <tr>
                                ...
                                <td>{{$ubicacion->Subalmacen->nombre_subalmacen}}</td>
                                ...
                                <td class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                        @can('fict.ubicaciones.editar') 
                                            <a class="dropdown-item" href=" {{ route('ubicacionesarticulos.edit', $ubicacion->id_ubicacion) }}"><i class="fa fa-edit"></i>Editar</a>
                                        @endcan
                                        @can('fict.ubicaciones.eliminar') 
...
@section('scripts')
    ...
    <script>
        $('#modal-eliminar').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('.modal-body h5').text('Desea Eliminar la Ubicaciones ' + nombre + ' ?') //cambia texto en el body del modal
        })
    </script>
