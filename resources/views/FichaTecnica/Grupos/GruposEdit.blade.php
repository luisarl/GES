...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{ route('grupos.index') }}">Grupos</a>
    </li>
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form method="POST" action=" {{ route('grupos.update', $grupo->id_grupo) }}" enctype="multipart/form-data">
            @csrf @method("put")
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text"
                        ...
                        placeholder="Ingrese el Codigo del Grupo" readonly>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nombre_grupo') is-invalid @enderror" name="nombre_grupo" value=" {{old('nombre_grupo', $grupo->nombre_grupo ?? '')}}" placeholder="Ingrese el Nombre del Grupo">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Descripción</label>
                <div class="col-sm-10">
                    <textarea rows="3" cols="3"class="form-control @error('descripcion_grupo') is-invalid @enderror" name="descripcion_grupo" placeholder="Ingrese la Descripción del Grupo">{{old('descripcion_grupo', $grupo->descripcion_grupo ?? '')}}</textarea>
                </div>
            </div>
