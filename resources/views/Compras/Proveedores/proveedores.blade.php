...
@include('Compras.Proveedores.ProveedoresDestroy')
...
<div class="card">
    <div class="card-header">
        ...
        @can('comp.proveedores.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('proveedores.create') !!}">
                    ...
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                @can('comp.proveedores.editar')
                                    <a class="dropdown-item" href=" {{ route('proveedores.edit', $proveedor->id_proveedor) }}"><i class="fa fa-edit"></i>Editar</a>
                                @endcan
                                @can('comp.proveedores.eliminar')
                                    <a class="dropdown-item" data-id="{{ $proveedor->id_proveedor}}" data-nombre="{{ $proveedor->nombre_proveedor }}"  data-toggle="modal" data-target="#modal-eliminar" href="#!"><i class="fa fa-trash"></i>Borrar</a>
                                @endcan
                            </div>
                        </td>
                    </tr>
