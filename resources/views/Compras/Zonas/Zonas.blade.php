...
@include('Compras.Zonas.ZonasDestroy')
...
<div class="card">
    <div class="card-header">
        ...
        @can('comp.zonas.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('zonas.create') !!}">
                    ...
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">  
                                @can('comp.zonas.editar')
                                    <a class="dropdown-item" href=" {{ route('zonas.edit', str_replace(' ', '',$zona->id_zona)) }}"><i class="fa fa-edit"></i>Editar</a>                            
                                @endcan
                                @can('comp.zonas.eliminar')
