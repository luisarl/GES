...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ asset('zonas/') }}">Zonas</a>
        </li>
...
@include('mensajes.MsjValidacion')
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form class="" method="POST" action=" {{ route('zonas.store') }}">
                @csrf
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Codigo</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control @error('id_zona') is-invalid @enderror" name="id_zona"
                           value="{{ old('id_zona') }}" placeholder="Codigo de la Zona">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nombre</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nombre_zona') is-invalid @enderror" name="nombre_zona"
                           value="{{ old('nombre_zona') }}" placeholder="Ingrese el Nombre de la Zona">
                    </div>
                </div>
                <hr>
