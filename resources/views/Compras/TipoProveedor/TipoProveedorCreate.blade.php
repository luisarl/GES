...
@include('mensajes.MsjValidacion')
    ...
    <div class="card">
        <div class="card-header">
            <h5>Crear Tipos de Proveedores</h5>

        </div>
        <div class="card-block">
            <h4 class="sub-title"></h4>
            <form class="" method="POST" action=" {{ route('tiposproveedor.store') }}">
                @csrf
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Codigo</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control @error('id_tipo') is-invalid @enderror" name="id_tipo"
                           value="{{ old('id_tipo') }}" placeholder="Codigo">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nombre_tipo') is-invalid @enderror" name="nombre_tipo"
                           value="{{ old('nombre_tipo') }}" placeholder="Ingrese el Tipo de Proveedor">
                    </div>
                </div>
                <hr>
