...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="#!">Tipos de Proveedores</a> </li>
</ul>
@endsection
...
@include('Compras.TipoProveedor.TipoProveedorDestroy')
...
<div class="card">
    <div class="card-header">
        ...
        @can('comp.tiposproveedor.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('tiposproveedor.create') !!}">
                    ...
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">  
                                @can('comp.tiposproveedor.editar') 
                                    <a class="dropdown-item" href=" {{ route('tiposproveedor.edit', str_replace(' ', '', $tipo->id_tipo)) }}"><i class="fa fa-edit"></i>Editar</a>                            
                                @endcan  
                                @can('comp.tiposproveedor.eliminar') 
                                    <a class="dropdown-item" data-id="{{ str_replace(' ', '', $tipo->id_tipo) }}" data-nombre="{{ $tipo->nombre_tipo }}"  data-toggle="modal" data-target="#modal-eliminar" href="#!"><i class="fa fa-trash"></i>Borrar</a>
                                @endcan  
                            </div>
                        </td>
                    </tr>
   ...
   <script src="{{ asset('libraries\bower_components\datatables.net\js\jquery.dataTables.min.js') }}"></script>
    ...
    <script>
        $('#modal-eliminar').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('.modal-body h5').text('Desea Eliminar el Proveedor ' + nombre + ' ?') //cambia texto en el body del modal
        })
    </script>
