...
@include('mensajes.MsjValidacion')
    ...
    <div class="card">
        <div class="card-header">
            <h5>Crear Segmentos</h5>

        </div>
        <div class="card-block">
            <h4 class="sub-title"></h4>
            <form class="" method="POST" action=" {{ route('segmentos.store') }}">
                @csrf
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Codigo</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control @error('id_segmento') is-invalid @enderror" name="id_segmento"
                           value="{{ old('id_segmento') }}" placeholder="Codigo del Segmento">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nombre</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nombre_segmento') is-invalid @enderror" name="nombre_segmento"
                           value="{{ old('nombre_segmento') }}" placeholder="Ingrese el segmento">
                    </div>
                </div>
                <hr>
