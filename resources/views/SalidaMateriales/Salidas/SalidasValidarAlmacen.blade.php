<div class="modal fade" id="modal-validar-almacen" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>Desea Validar la Salida del Material por Almacen?</h5>
                <br>
                <p class=""> <span class="font-weight-bold">NOTA: </span> AL VALIDAR LA SALIDA NO SE PODRA REALIZAR NINGUNA MODIFICACIÓN</p>
            </div>
            <div class="modal-footer">
               <form method="GET" action=" {{ route('validarsalidaalmacen', $salida->id_salida) }}" >
                    @csrf
