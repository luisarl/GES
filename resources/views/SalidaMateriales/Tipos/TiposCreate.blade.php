...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ route('tiposactivos.index') }}">Tipos</a>
        </li>
...
@include('mensajes.MsjValidacion')
    ...
    <div class="card">
        <div class="card-header">
            <h5>Crear Tipo de Activo</h5>

        </div>
        <div class="card-block">
            <h4 class="sub-title"></h4>
            <form class="" method="POST" action=" {{ route('asaltipos.store') }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="3" cols="3" class="form-control @error('descripcion_tipo') is-invalid @enderror" name="descripcion_tipo"
                            placeholder="Ingrese la Descripción del Tipo">{{ old('descripcion_tipo') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
