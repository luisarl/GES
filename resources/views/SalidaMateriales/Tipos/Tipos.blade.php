...
@section('titulo', 'Tipos de Salidas')

@section('titulo_pagina', 'Tipos de Salidas')
...
@include('SalidaMateriales.Tipos.TiposDestroy')
...
<div class="card">
    <div class="card-header">
        ...
        @can('asal.tipos.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('asaltipos.create') !!}">
                    ...
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu"> 
                                @can('asal.tipos.editar')
                                    <a class="dropdown-item" href=" {{ route('asaltipos.edit', $tipo->id_tipo) }}"><i class="fa fa-edit"></i>Editar</a>
                                @endcan
                                @can('asal.tipos.eliminar')
