...
@section('titulo_pagina', 'Crear Tipo de Combustible')
...
<div class="card-header">
    ...
    <div class="card-block">
        <form method="POST" action="{{ route('cntctiposcombustible.store') }}">
            @csrf
            <div class="form-group row">
                <div class="col-md-3 col-lg-3">
                    <label for="motivo" class="form-label">Nombre Combustible</label>
                    <input type="text" name="combustible" id="combustible" class="form-control @error('combustible') is-invalid @enderror" placeholder="Ingrese combustible" value="{{ old('combustible') }}">
                </div> 

                <div class="col-md-3 col-lg-3">
                    <label for="departamento" class="form-label">Departamentos Responsable</label>
