...
<div class="card">
    ...
    <div class="card-block">
        <form method="POST" action="{{ route('cntcdespachos.store') }}">
            @csrf
            <div class="form-group row">
                ...
                <div class="col-md-3 col-lg-3">
                    ...
                    <input type="text" name="motivo" id="motivo" class="form-control @error('motivo') is-invalid @enderror" placeholder="Ingrese motivo" value="{{ old('motivo') }}">
                </div>
            </div> 
            ...
            <div class="form-group row">
                    <div class="form-radio col-sm-2"> 
                        <div class="radio radio-inline">
                            <label>
                                <input type="radio" name="equipo" id="EquipoVehiculo" value="VEHICULO" onClick="TipoEquipo();" checked>
                                <i class="helper"></i>Vehiculo
                            </label>
                        </div>
                        <div class="radio radio-inline">
                            <label>
                                <input type="radio" name="equipo" id="EquipoOtro" value="OTRO" {{ old('equipo')=="OTRO" ? 'checked='.'"'.'checked'.'"' : '' }} onClick="TipoEquipo();">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-0 form-label">Responsable</label>
                        ...
                        <div class="col-sm-3 @error('conductorforaneo') is-invalid @enderror" id="ConductorForaneo">
                            <label for="responsable" class="form-label">Responsable</label>
                            <input type="text" name="conductorforaneo" id="conductorforaneo" class="form-control @error('conductorforaneo') is-invalid @enderror" placeholder="Nombre del Responsable" value="{{ old('conductorforaneo') }}">
                        </div>
