...
@section('titulo', 'Solicitudes de Resguardo')

@section('titulo_pagina', 'Solicitud de Resguardo')
...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{ url('resgsolicitudes') }}">Solicitudes Resguardo</a> </li>
    ...
    <div class="card-block">
        <div class="row">
            <div class="col-lg-12 col-xs-12 product-detail" id="product-detail">
                <div class="row">
                    <div class="col-lg-12">
                        <span class="txt-muted d-inline-block h6 m-r-10"><strong>CORRELATIVO Nº {{$solicitud->id_solicitud_resguardo}} </strong> </span>
                        ...
                        {{-- @if ($salida->anulado != 'SI')
                            ...
                            <a href="{{ route('resgsolicitudes.edit', $solicitud->id_solicitud_resguardo) }}" type="button"
                    ...
                    <div class="col-lg-6">
                        <h6 class="txt-muted"><strong>UBICACION ACTUAL: </strong> {{$solicitud->ubicacion_actual}} </h6>
                        <h6 class="txt-muted"><strong>ALMACEN RECEPTOR: </strong> {{$solicitud->nombre_almacen}} </h6>   
                    </div>
                    <div class="col-lg-12">
                        <hr>
