...
@section('titulo_pagina', 'Solicitudes de Despacho')
...
<div class="card">
    <div class="card-header">
        ...
        @can('resg.soldespacho.crear')
        <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('resgdespachos.create') !!}">
            ...
            <table id="datatable" class="table table-striped table-bordered nowrap" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$solicitud->ubicacion_destino}}</td>
                        <td>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                @can('resg.soldespacho.ver')
                                    <a class="dropdown-item" href="{{ route('resgdespachos.show', $solicitud->id_solicitud_despacho) }}">
                                    <i class="fa fa-eye"></i>Ver</a>
                                @endcan
                               
                                @if ($solicitud->estatus != 'ANULADO')
                                @can('resg.soldespacho.editar')
                                <a class="dropdown-item"
                                    href="{{ route('resgdespachos.edit',$solicitud->id_solicitud_despacho) }}">
                                    <i class="fa fa-edit"></i>Editar</a>
                                @endcan
                                @endif
                                @if ($solicitud->estatus == 'POR APROBACION' || $solicitud->estatus == 'APROBADO')
                                @can('resg.soldespacho.eliminar')
                                <a class="dropdown-item" data-id="{{ $solicitud->id_solicitud_despacho}}"
                                    data-nombre="{{ $solicitud->id_solicitud_despacho }}" data-toggle="modal"
