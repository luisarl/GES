...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ asset('paises/') }}">Paises</a>
        </li>
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form method="POST" action=" {{ route('paises.update', $pais->id_pais) }}" enctype="multipart/form-data">
            @csrf @method("put")
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Codigo Pais</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control @error('id_pais') is-invalid @enderror" name="id_pais" value=" {{old('id_pais', $pais->id_pais ?? '')}}" placeholder="Ingrese el Codigo del Pais" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nombre</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nombre_pais') is-invalid @enderror" name="nombre_pais" value=" {{old('nombre_pais', $pais->nombre_pais ?? '')}}" placeholder="Ingrese el Nombre del Pais">
                </div>
            </div>
            <hr>
