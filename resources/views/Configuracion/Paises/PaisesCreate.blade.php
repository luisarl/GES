...
@include('mensajes.MsjValidacion')
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form class="" method="POST" action=" {{ route('paises.store') }}">
                @csrf
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Codigo</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control @error('id_pais') is-invalid @enderror" name="id_pais"
                           value="{{ old('id_pais') }}" placeholder="Ingrese el codigo del Pais">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nombre</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nombre_pais') is-invalid @enderror" name="nombre_pais"
                           value="{{ old('nombre_pais') }}" placeholder="Ingrese el Nombre del Pais">
                    </div>
                </div>
                <hr>
