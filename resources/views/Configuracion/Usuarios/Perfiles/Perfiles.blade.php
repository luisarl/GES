...
@include('Configuracion.Usuarios.Perfiles.PerfilesDestroy')        
    <!-- Scroll - Vertical table end -->
    <!-- Scroll - Vertical, Dynamic Height table end -->
    <div class="card">
        <div class="card-header">
            <h5>Listado de Perfiles</h5>
            @can('conf.perfiles.crear')
                <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('perfiles.create') !!}">
                        ...
                        <tr>
                            ...
                            <td class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                    @can('conf.perfiles.editar')
                                        <a class="dropdown-item" href="  {{ route('perfiles.edit', $perfil->id) }}"><i class="fa fa-edit"></i>Editar</a>
                                    @endcan
                                    @can('conf.perfiles.eliminar')
                                        <a class="dropdown-item" data-id="{{ $perfil->id }}" data-nombre="{{ $perfil->name }}" data-toggle="modal"
...
@section('scripts')
    ...
    <script>
        $('#modal-eliminar').on('show.bs.modal', function (event) {
                ...
                var modal = $(this)
                modal.find('.modal-body h5').text('Desea Eliminar el Perfil ' + nombre + ' ?') //cambia texto en el body del modal
            })
    </script>
@endsection
