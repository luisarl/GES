...
@include('Configuracion.Usuarios.Usuarios.UsuariosDestroy')
<!-- Scroll - Vertical table end -->
<!-- Scroll - Vertical, Dynamic Height table end -->
<div class="card">
    <div class="card-header">
        <h5>Listado de Usuarios</h5>
        @can('conf.usuarios.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('usuarios.create') !!}">
                        ...
                        <tr>
                            ...
                            <td class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                    @can('conf.usuarios.editar')
                                        <a class="dropdown-item" href="{{ route('usuarios.edit', $usuario->id) }}"><i
                                                class="fa fa-edit"></i>Editar</a>
                                    @endcan
                                    @can('conf.usuarios.eliminar')
                                        <a class="dropdown-item" data-id="{{ $usuario->id }}" data-nombre="{{ $usuario->name }}" data-toggle="modal"
...
@section('scripts')
    ...
    <script>
        $('#modal-eliminar').on('show.bs.modal', function (event) {
                ...
                var modal = $(this)
                modal.find('.modal-body h5').text('Desea Eliminar El Usuario ' + nombre + ' ?') //cambia texto en el body del modal
            })
    </script>
