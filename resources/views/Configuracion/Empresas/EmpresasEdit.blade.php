        ...
        <div class="card-block">
            ...
            <form method="POST" action="{{ route('empresas.update', $empresa->id_empresa) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nombre_empresa') is-invalid @enderror"
                            name="nombre_empresa" value=" {{ old('nombre_empresa', $empresa->nombre_empresa ?? '') }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('alias_empresa') is-invalid @enderror"
                            name="alias_empresa" value=" {{ old('alias_empresa', $empresa->alias_empresa ?? '') }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <input type="text" class="form-control @error('rif') is-invalid @enderror" name="rif"
                            value=" {{ old('rif', $empresa->rif ?? '') }}" placeholder="J-0000000">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-lg-2">Presidente</label>
                    <div class="col-md-4 col-lg-4">
                        <input type="presidente" class="form-control @error('presidente') is-invalid @enderror"
                            name="presidente" value="{{ old('presidente', $empresa->presidente ?? '') }}"
                            placeholder="Ingrese el Nombre del Presidente">
                    </div>
                    <label class="col-md-2 col-lg-2">Correo Presidente</label>
                    <div class="col-md-4 col-lg-4">
                        <input type="correo_presidente"
                            class="form-control @error('correo_presidente') is-invalid @enderror" name="correo_presidente"
                            value="{{ old('correo_presidente', $empresa->correo_presidente ?? '') }}" placeholder="Ingrese el Correo Presidente">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-lg-2">Responsable Almacen</label>
                    <div class="col-md-4 col-lg-4">
                        <input type="responsable_almacen"
                            class="form-control @error('responsable_almacen') is-invalid @enderror"
                            name="responsable_almacen" value="{{ old('responsable_almacen', $empresa->responsable_almacen ?? '') }}"
                            placeholder="Ingrese el Nombre del Responsable">
                    </div>
                    <label class="col-md-2 col-lg-2">Correo Responsable</label>
                    <div class="col-md-4 col-lg-4">
                        <input type="correo_responsable"
                            class="form-control @error('correo_responsable') is-invalid @enderror" name="correo_responsable"
                            value="{{ old('correo_responsable', $empresa->correo_responsable ?? '') }}" placeholder="Ingrese el Correo del Responsable">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-lg-2">Superior Almacen</label>
                    <div class="col-md-4 col-lg-4">
                        <input type="superior_almacen" class="form-control @error('superior_almacen') is-invalid @enderror"
                            name="superior_almacen" value="{{ old('superior_almacen', $empresa->superior_almacen ?? '') }}"
                            placeholder="Ingrese el Nombre del Superior">
                    </div>
                    <label class="col-md-2 col-lg-2">Correo Superior</label>
                    <div class="col-md-4 col-lg-4">
                        <input type="correo_superior" class="form-control @error('correo_superior') is-invalid @enderror"
                            name="correo_superior" value="{{ old('correo_superior', $empresa->correo_superior ?? '') }}"
                            placeholder="Ingrese el Correo del Superior">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <input type="text" class="form-control @error('base_datos') is-invalid @enderror"
                            name="base_datos" value=" {{ old('base_datos', $empresa->base_datos ?? '') }}"
                    ...
                    <div class="checkbox-zoom zoom-primary">
                        <label class="col-md-4 col-lg-4">
                            <input type="checkbox" value="SI" name="visible_ficht"
                                @if (str_replace(' ', '', $empresa->visible_ficht) == 'SI') checked @endif>
                            <span class="cr">
