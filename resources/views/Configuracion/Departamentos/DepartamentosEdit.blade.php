...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form method="POST" action=" {{ route('departamentos.update', $departamento->id_departamento) }}" enctype="multipart/form-data">
            @csrf @method("put")
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nombre del departamento</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control @error('nombre_departamento') is-invalid @enderror" name="nombre_departamento" value=" {{old('nombre_departamento', $departamento->nombre_departamento ?? '')}}" placeholder="Ingrese el Nombre del Departamento">
                </div>
                <label class="col-sm-2 col-form-label">Prefijo</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control @error('prefijo') is-invalid @enderror" name="prefijo"
                           value="{{ old('prefijo', $departamento->prefijo ?? '') }}" placeholder="Ingrese el Prefijo">
                    </div>
            </div>
            <div class="form-group row">
                <label class="col-md-2 col-lg-2">Responsable</label>
                <div class="col-md-4 col-lg-4">
                    <input type="text" class="form-control @error('responsable') is-invalid @enderror" name="responsable" value=" {{old('responsable', $departamento->responsable ?? '')}}" placeholder="Ingrese el nombre del Responsable">
                </div>
                <label class="col-md-2 col-lg-2">Correo Principal</label>
                <div class="col-md-4 col-lg-4">
                    <input type="text" class="form-control @error('correo') is-invalid @enderror" name="correo" value=" {{old('correo', $departamento->correo ?? '')}}" placeholder="Ingrese el Correo principal">
                </div>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-1 col-md-1 col-lg-1">
                        <div class="checkbox-fade fade-in-primary">
                            <label>
                                <input type="checkbox" id="aplica_servicios" name="aplica_servicios" value="SI" @if($departamento->aplica_servicios == 'SI') checked @endif>
                                <span class="cr">
                    ...
                    <div class="col-md-2 col-lg-2">
                       ...
                       value="{{$departamento->correlativo_servicios}}" readonly>
                   </div>
                </div>
            <hr>
