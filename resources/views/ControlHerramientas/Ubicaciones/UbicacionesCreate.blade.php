...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ url('ubicaciones/') }}">Ubicacion</a>
        </li>
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form class="" method="POST" action=" {{ route('ubicaciones.store') }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 @error('id_almacen') is-invalid @enderror">
                    <select name="id_almacen" id="id_almacen" class="js-example-basic-single form-control">
