...
@include('ControlHerramientas.Ubicaciones.UbicacionesDestroy')

    <div class="card">
        <div class="card-header">
            <h5>Listado de Ubicaciones</h5>
            @can('cnth.ubicaciones.crear') 
                <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('ubicaciones.create') !!}">
                ...
                <table id="datatable" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        @foreach ($ubicaciones as $ubicacion)
                            <tr>
                                <td>{{$ubicacion->almacen->nombre_almacen}}</td>
                                ...
                                <td class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                        @can('cnth.ubicaciones.editar') 
                                            <a class="dropdown-item" href=" {{ route('ubicaciones.edit', $ubicacion->id_ubicacion) }}"><i class="fa fa-edit"></i>Editar</a>
                                        @endcan
                                        @can('cnth.ubicaciones.eliminar') 
                                            <a class="dropdown-item" data-id="{{ $ubicacion->id_ubicacion }}" data-nombre="{{ $ubicacion->codigo_ubicacion }}"  data-toggle="modal" data-target="#modal-eliminar" href="#!"><i class="fa fa-trash"></i>Borrar</a>
                                        @endcan 
                                    </div>
                                </td>
                            </tr>
