...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ route('empleados.index') }}">Responsables</a>
        </li>
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form class="" method="POST" action=" {{ route('empleados.store') }}">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Nombre Responsable</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('nombre_empleado') is-invalid @enderror"
                                        name="nombre_empleado" value="{{ old('nombre_empleado') }}" placeholder="Ingrese el Nombre">
                                </div>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <select name="id_departamento" class="js-example-basic-single form-control">
                                        ...
                                        @foreach ($departamentos as $departamento)
                                            <option value="{{ $departamento->id_departamento }}"
                                                @if ($departamento->id_departamento == old('id_departamento', $empleado->id_departamento ?? '')) selected = "selected" @endif>
