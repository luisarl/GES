...
@include('ControlHerramientas.Grupos.GruposDestroy')
...
<div class="card">
    <div class="card-header">
        ...
        @can('cnth.grupos.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('cnthgrupos.create') !!}">
                    ...
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                @can('cnth.grupos.editar')
                                    <a class="dropdown-item" href=" {{ route('cnthgrupos.edit', $grupo->id_grupo) }}"><i class="fa fa-edit"></i>Editar</a>
                                @endcan
                                @can('cnth.grupos.eliminar')
