...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ asset('cnthgrupos/') }}">Grupos</a>
        </li>
...
@include('mensajes.MsjValidacion')
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form class="" method="POST" action=" {{ route('cnthgrupos.store') }}">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number"
                            ...
                            placeholder="Solo llenar por el Almacenista">
                    </div>
                </div>
