...
@section('titulo_pagina', 'Detalle Entrada')

@section('menu_pagina')
<ul class="breadcrumb-title">
    <li class="breadcrumb-item"><a href="{{ url('/dashboardcnth') }}"> <i class="feather icon-home"></i> </a></li>
    <li class="breadcrumb-item"><a href="#!">Detalle Entrada</a> </li>
</ul>
@endsection
...
<div class="card">
    <div class="card-header">
        <h4 class="sub-title "> <strong>Entrada Nº {{$detalle->id_entrada}}</strong> </h4>
    </div>
