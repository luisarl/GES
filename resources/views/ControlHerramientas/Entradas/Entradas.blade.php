...
<div class="card">
    <div class="card-header">
        ...
        @can('cnth.entradas.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('entradas.create') !!}">
                            ...
                            <td class="dropdown">
                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cog" aria-hidden="true"></i></button>
                                    <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                        @can('cnth.entradas.ver')
                                            <a class="dropdown-item" href="{{ route('entradas.show', $entrada->id_entrada) }}"><i class="fa fa-eye"></i>Ver</a>
                                        @endcan
                                    </div>
                            </td>
                        </tr>
