...
@section('titulo_pagina', 'Entradas')

@section('menu_pagina')
<ul class="breadcrumb-title">
    <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="feather icon-home"></i> </a></li>
    <li class="breadcrumb-item"><a href="{{ route('dashboardcnth') }}"> </i> Control Herramientas</a></li>
    <li class="breadcrumb-item"><a href="{{ route('entradas.index')}}">Entradas</a> </li>
...
<!-- personalizado -->
<script type="text/javascript" src="{{ asset('libraries\assets\js\CnthEntradas.js') }}"></script>
