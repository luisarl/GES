...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{ route('cnthcategorias.index') }}">Categorias</a>
    </li>
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form method="POST" action=" {{ route('cnthcategorias.update', $cnthcategoria->id_categoria) }}" enctype="multipart/form-data">
            @csrf @method("put")
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number"
                        ...
                        value="{{ old('cod_categoria_profit', $cnthcategoria->codigo_categoria ?? '') }}"
                        placeholder="Solo llenar por el Almacenista" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nombre</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nombre_categoria') is-invalid @enderror" name="nombre_categoria" value=" {{old('nombre_categoria', $cnthcategoria->nombre_categoria ?? '')}}" placeholder="Ingrese el Nombre de la Categoria">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Descripción</label>
                <div class="col-sm-10">
                    <textarea rows="3" cols="3"class="form-control @error('descripcion_categoria') is-invalid @enderror" name="descripcion_categoria" placeholder="Ingrese la Descripción de la Categoria">{{old('descripcion_categoria', $cnthcategoria->descripcion_categoria ?? '')}}</textarea>
                </div>
            </div>
