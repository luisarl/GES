...
@include('ControlHerramientas.Categorias.CategoriasDestroy')
...
<div class="card">
    <div class="card-header">
        ...
        @can('cnth.categorias.crear')
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('cnthcategorias.create') !!}">
    ...
    <div class="card-block">
        <div class="dt-responsive table-responsive">
            <table id="datatable" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    @foreach ($cnthcategorias as $categoria)
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                @can('cnth.categorias.editar')
                                    <a class="dropdown-item" href="  {{ route('cnthcategorias.edit', $categoria->id_categoria) }}"><i class="fa fa-edit"></i>Editar</a>
                                @endcan 
                                @can('cnth.categorias.eliminar')
