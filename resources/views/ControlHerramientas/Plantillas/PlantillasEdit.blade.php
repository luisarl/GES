...
@section('titulo_pagina', 'Editar Plantilla')
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form method="POST" action=" {{ route('plantillas.update', $plantilla->id_plantilla) }}"
                ...
                <div class="col-md-10 col-lg-10 @error('id_almacen') is-invalid @enderror">
                    <select name="id_almacen" id="_almacenes"
                        ...
                        <option value="{{ $almacen->id_almacen }}" @if ($almacen->id_almacen ==
                            old('id_almacen', $plantilla->id_almacen ?? '')) selected = "selected" @endif>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nombre_plantilla') is-invalid @enderror"
                        name="nombre_plantilla" value="{{ old('nombre_plantilla', $plantilla->nombre_plantilla ?? '') }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea rows="3" cols="3"
                        ...
                        placeholder="Ingrese la Descripción de la Plantilla">{{ old('descripcion_plantilla', $plantilla->descripcion_plantilla ?? '') }}</textarea>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="tablaajuste">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td id="id_plantilla_detalle" style='visibility:collapse; display:none;'> {{$herramienta->id_plantilla_detalle}}</td>
                            <td id="id_herramienta">{{$herramienta->id_herramienta}}</td>
                            <td id="nombre_herramienta">{{$herramienta->nombre_herramienta}}</td>
                            <td id="cantidad" contenteditable='true'>{{$herramienta->cantidad}}</td>
                            <td>
                                <button type="button" onclick="EliminarDetalle({{ $herramienta->id_plantilla_detalle }})"
...
<script>
    ...
    var EliminarHerramienta = "{{ url('eliminarherramientaplantilla') }}";
</script>
