...
@section('contenido')
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form class="" method="POST" action=" {{ route('cnthsubgrupos.store') }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="3" cols="3" class="form-control @error('descripcion_subgrupo') is-invalid @enderror"
                            name="descripcion_subgrupo" placeholder="Ingrese la Descripción del SubGrupo">{{ old('descripcion_subgrupo') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
