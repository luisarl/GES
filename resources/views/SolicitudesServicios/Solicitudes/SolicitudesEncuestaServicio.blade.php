...
@section('titulo_pagina', 'Encuesta del Servicio')
...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="#!">Encuesta del Servicio</a> </li>
</ul>
...
<div class="card">
    <div class="card-header">
        <h5>Encuesta del Servicio Nº {{$solicitud->id_solicitud}} </h5>
        <hr>
    ...
    <div class="card-block">
        @if($EncuestaEnviada == 'SI')
            <div class="alert alert-success background-success">
                <strong>La Encuesta Del Servicio Fue Enviada</strong> 
            </div>
        @else
            <div class="j-wrapper j-wrapper-640">
                <form action="{{route('solsencuestaservicio',$solicitud->id_solicitud)}}" method="post" class="j-pro" id="j-pro" novalidate="">
                    @csrf
                    <div class="j-content">
                        <!-- start name -->
                        <div class="j-unit">
                            ...
                            <div class="j-input">
                                ...
                                <input type="text" id="nombre_usuario" name="nombre_usuario" placeholder="" value="{{Auth::user()->name}}" readonly>
                            </div>
                        </div>
                        <!-- end name -->
                        <!-- start email-->
                        ...
                        <div class="j-unit">
                            <div class="j-rating-group">
                                ...
                                <label class="j-label">Calidad y eficiencia del servicio</label>
                                <div class="j-ratings">
                            ...
                            <div class="j-rating-group">
                                <label class="j-label">Nivel de cumplimiento con los plazos de tiempo ofrecidos</label>
                                <div class="j-ratings">
                                    ...
                                    <input id="1s" type="radio" name="calificacion_pregunta2" value="1" checked="">
                                    <label for="1s">
                                        <i class="icofont icofont-star"></i>
                                    </label>
                                </div>
                            ...
                            <div class="j-rating-group">
                                <label class="j-label">Nivel de información sobre el progreso del servicio</label>
                                <div class="j-ratings">
                                    <input id="5supp" type="radio" name="calificacion_pregunta3" value="5">
                                    <label for="5supp">
                                        <i class="icofont icofont-star"></i>
                                    </label>
                                    <input id="4supp" type="radio" name="calificacion_pregunta3" value="4">
                                    <label for="4supp">
                                        <i class="icofont icofont-star"></i>
                                    </label>
                                    <input id="3supp" type="radio" name="calificacion_pregunta3" value="3">
                                    <label for="3supp">
                                        <i class="icofont icofont-star"></i>
                                    </label>
                                    <input id="2supp" type="radio" name="calificacion_pregunta3" value="2">
                                    <label for="2supp">
                                        <i class="icofont icofont-star"></i>
                                    </label>
                                    <input id="1supp" type="radio" name="calificacion_pregunta3" value="1" checked="">
                                    <label for="1supp">
                                        <i class="icofont icofont-star"></i>
                                    </label>
                                </div>
