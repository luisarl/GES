...
@section('contenido')
    ...
    @include('SolicitudesServicios.Responsables.ResponsablesDestroy')

    <!-- Scroll - Vertical table end -->
    <!-- Scroll - Vertical, Dynamic Height table end -->
    <div class="card">
        <div class="card-header">
            <h5>Listado de Responsables de Solicitudes</h5>
            @can('sols.responsables.crear')
                <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('responsables.create') !!}"> <!-- MODIFICAR RUTA -->
                            ...
                            <tr>
                                ...
                                <td class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                        @can('sols.responsables.editar')
                                            <a class="dropdown-item" href="{{ route('responsables.edit', $responsable->id_responsable) }}"><i class="fa fa-edit"></i>Editar</a> <!-- MODIFICAR RUTA -->
                                        @endcan
                                        @can('sols.responsables.eliminar')
