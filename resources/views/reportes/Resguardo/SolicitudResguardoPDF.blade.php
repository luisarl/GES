...
<body>
    ...
    <h1 class="center">SOLICITUD DE RESGUARDO</h1>
        ...
        <tbody>
            <tr>
                ...
                <td style="width:80px">
                    ...
                    {{$solicitud->ubicacion_actual}}
                </td>
                <td style="width:80px">
                    <h5>ALMACEN RECEPTOR</h5>
        ...
        <tbody>
            <tr>
                <td style="width:30%">
                    ...
                    <h1 class="center">{{$solicitud->id_solicitud_resguardo}}{{--$salida->id_salida--}}</h1>   
