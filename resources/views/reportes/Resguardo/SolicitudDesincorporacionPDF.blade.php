...
<body>
    ...
    <h1 class="center">SOLICITUD DE DESINCORPORACION</h1>
    ...
    <table border="1">
        <tbody>
            <tr>
                <td style="width:30%">
                    ...
                    <h1 class="center">{{$solicitud->id_solicitud_desincorporacion}}{{--$salida->id_salida--}}</h1>   
        ...
        <table border="1" class="center">
            <tbody>
                <tr  style="border-bottom: 1pt solid black;">
                    <td style="width:80px">
                        <h5 class="firma">GERENTE/JEE DE ALMACEN</h5>
                        {{-- <small>{{$salida->autorizado}}</small> --}}
                        <h6>Nombre, Firma</h6>
                        {{-- <h6>Nombres, Firma, Fecha</h6> --}}
                    </td>
                    <td style="width:80px">
                        <h5 class="firma">REVISADO POR</h5>
                        {{-- <small>{{$salida->responsable_almacen}}</small> --}}
                        <h6>Nombre, Firma</h6>
                        {{-- <h6>Nombres, Firma, Fecha</h6> --}}
                    </td>
                    <td style="width:80px">
                        <h5 class="">GERENTE/JEE DE AUDITORIA</h5>
                        <h6 class="firma"></h6>
                        <h6>Nombre, Firma</h6>
                    </td>
                    <td style="width:80px">
                        <h5 class="">PERSONAL DE SEGURIDAD</h5>
                        <h6 class="firma"></h6>
                        <h6>Nombre, Firma</h6>
                    </td>
                </tr>
