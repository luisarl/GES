...
@section('titulo_pagina', 'Reporte Solicitudes de Compra por Departamentos')
...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="#!">Solicitudes de Compra por Departamentos</a> </li>
</ul>
@endsection
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div id="grafico_solp_departamentos" style="width: 100%; height: 600px;"></div>
            </div>
        </div>
    </div>
</div>
