...
@section('titulo_pagina', 'Reporte Solicitudes de Compra por Estatus')
...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="#!">Solicitudes de Compra por Estatus</a> </li>
</ul>
@endsection
    ...
    <div class="card-block">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-7">
                <div id="grafico_solp_estatus" style="width: 100%; height: 600px;"></div>
            </div>
        </div>
    </div>
</div>
