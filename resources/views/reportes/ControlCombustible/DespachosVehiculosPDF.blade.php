    ...
    <table border="1" class="center">
        ...
        <table border="1">
         ...
         <br>
             ...
             <h1 class="center">CANTIDAD DESPACHADA POR VEHICULOS</h1>
         <table border="1">
            <tbody>
             
                <tr style="border-bottom: 1pt solid black;">
                  
                    <th style="width:1%">VEHICULO/EQUIPO</th>
                    <th style="width:1%">PLACA VEHICULO/EQUIPO</th>
                    <th style="width:1%">CANTIDAD DESPACHADA</th>
                ...
                @foreach($gerencias as $gerencia)
                    ...
                    <tr>
                       <td>{{$gerencia->marca_equipo}}</td>
                       <td>{{$gerencia->placa_equipo}}</td>
