...
@section('titulo','SE HA PROCESADO UNA SOLICITUD DE DESPACHO DE COMBUSTIBLE')
...
<ul>
    ...
    <li>Procesada por: {{$solicitud->aceptado_por}}</li>
    ...
    <li>Cantidad de Combustible Despachado: {{number_format($solicitud->total_despachado,2)}}</li>
...
@section('url', Request::root().'/cntcdespachos/'.$solicitud->id_solicitud_despacho)
