...
<div class="card">
    <div class="card-header">
        <h5>Crear Tecnologia</h5>
    </div>
    <div class="card-block">
        <h4 class="sub-title"></h4>
        <form class="" method="POST" action=" {{ route('cenctecnologia.store') }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nombre_tecnologia') is-invalid @enderror" name="nombre_tecnologia" 
                        value="{{ old('nombre_tecnologia') }}" placeholder="Ingrese nombre de la tecnologia">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea rows="3" cols="3" class="form-control @error('descripcion_tecnologia') is-invalid @enderror" name="descripcion_tecnologia" 
                        placeholder="Ingrese la descripción de la tecnologia">{{ old('descripcion_tecnologia') }}</textarea>
                </div>
            </div>
            <hr>
