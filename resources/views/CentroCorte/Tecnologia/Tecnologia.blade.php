...
@include('CentroCorte.Tecnologia.TecnologiaDestroy')

<div class="card">
    <div class="card-header">
        <h5>Listado de Tecnologias</h5>
        @can('cenc.tecnologia.crear')  
            <a class="btn btn-primary float-right" title="Nuevo" href="{{ route('cenctecnologia.create') }}">
    ...
    <div class="card-block">
        <div class="dt-responsive table-responsive">
            <table id="datatable" class="table table-striped table-bordered nowrap table-responsive">
                ...
                <tbody>
                    {{-- la variable $tecnologia viene del controller: CencTecnologiaController --}}
                    @foreach($tecnologias as $tecnologia)
                    <tr>
                        <td>{{$tecnologia->id_tecnologia}}</td>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                @can('cenc.tecnologia.editar')  
                                    <a class="dropdown-item" href=" {{ route('cenctecnologia.edit', $tecnologia->id_tecnologia) }}"><i
                                            class="fa fa-edit"></i>Editar</a>
                                @endcan
                                @can('cenc.tecnologia.eliminar')  
                                    <a class="dropdown-item" data-id="{{ $tecnologia->id_tecnologia }}"
                                        data-nombre="{{ $tecnologia->nombre_tecnologia }}" data-toggle="modal"
