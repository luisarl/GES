    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>¿Desea Activar el Aprovechamiento?</h5>
                <br>
            </div>
            <form id="formactivar" method="POST" action=" {{ route('cencaprovechamientosAbrir',1) }}" data-action=" {{ route('cencaprovechamientosAbrir',1) }}" >
                @csrf 
