...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ asset('cencresponsables/') }}">Responsable</a>
        </li>
        <li class="breadcrumb-item"><a href="#!">Editar Responsable</a> </li>
    </ul>
@endsection
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form method="POST" action=" {{ route('cencresponsables.update', $responsable->id_responsable) }}"
                                    ...
                                    <select name="id_departamento" class="js-example-basic-single form-control">
                                        @foreach ($departamentos as $departamento)
                                            <option value="{{ $departamento->id_departamento }}"
                                                @if ($departamento->id_departamento == old('id_departamento', $responsable->id_departamento ?? '')) selected = "selected" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('nombre_responsable') is-invalid @enderror"
                                        name="nombre_responsable" value=" {{ old('nombre_responsable', $responsable->nombre_responsable ?? '') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('cargo_responsable') is-invalid @enderror"
                                        name="cargo_responsable" value="{{ old('cargo_responsable',$responsable->cargo_responsable ?? '') }}" placeholder="Ingrese el Cargo">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('correo') is-invalid @enderror"
                                        name="correo" value="{{ old('correo',$responsable->correo ?? '') }}" placeholder="Ingrese el Correo">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            ...
                                            value="SI" @if($responsable->estatus == 'SI') checked @endif> Activo </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="estatus"
                                                value="NO" @if($responsable->estatus == 'NO') checked @endif> Inactivo </label>
                                    </div>
                                </div>
                            </div>
