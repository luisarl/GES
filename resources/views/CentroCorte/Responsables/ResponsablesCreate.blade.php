...
@section('menu_pagina')
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="{{ route('cencresponsables.index') }}">Responsables</a>
        </li>
        <li class="breadcrumb-item"><a href="#!">Crear Responsable </a> </li>
    </ul>
@endsection
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form class="" method="POST" action=" {{ route('cencresponsables.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('correo') is-invalid @enderror" name="correo"
                                        id="correoInput" value="{{ old('correo') }}" placeholder="Ingrese el Correo">
