...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="#!">Editar Tipo</a> </li>
</ul>
...
<div class="card">
    <div class="card-header">
        <h5>Editar Tipo de Ficha</h5>
    </div>
    <div class="card-block">
        <h4 class="sub-title"></h4>
        <form method="POST" action=" {{ route('cencfichastipos.update', $tipo->id_tipo) }}" enctype="multipart/form-data">
            @csrf @method("put")
