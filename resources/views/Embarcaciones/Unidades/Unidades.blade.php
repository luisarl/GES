...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{route('embaunidades.index')}}">Unidades de Medida</a> </li>
...
@include('Embarcaciones.Unidades.UnidadesDestroy')

<div class="card">
    <div class="card-header">
        <h5>Listado de Unidades de Medida</h5>
        @can('emba.unidades.crear') 
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('embaunidades.create') !!}">
                    ...
                    <tr>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                     @can('emba.unidades.editar') 
                                    <a class="dropdown-item" href=" {{ route('embaunidades.edit', $unidad->id_unidad) }}"><i
                                            class="fa fa-edit"></i>Editar</a>
                                    @endcan
                                    @can('emba.unidades.eliminar')
                                    <a class="dropdown-item" data-id="{{ $unidad->id_unidad }}"
                                        data-nombre="{{ $unidad->nombre_unidad }}" data-toggle="modal"
