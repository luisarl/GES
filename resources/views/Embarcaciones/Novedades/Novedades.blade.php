...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{route('embanovedades.index')}}">Novedades</a> </li>
...
@include('Embarcaciones.Novedades.NovedadesDestroy')

<div class="card">
    <div class="card-header">
        <h5>Listado de Novedades</h5>
        @can('emba.novedades.crear') 
            <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('embanovedades.create') !!}">
            ...
            <table id="datatable" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$novedad->motivo_novedad}} </td>
                        {{-- <td>
                            @php
                              $descripcion_parametro = wordwrap($novedad->descripcion_parametro, 15, "<br>", false);
                            @endphp
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                @can('emba.novedades.editar')
                                    <a class="dropdown-item" href=" {{ route('embanovedades.edit', $novedad->id_novedad) }}"><i
                                            class="fa fa-edit"></i>Editar</a>
                                @endcan
                                @can('emba.novedades.eliminar')
                                    <a class="dropdown-item" data-id="{{ $novedad->id_novedad }}"
                                        data-nombre="{{ $novedad->motivo_novedad }}" data-toggle="modal"
