...
@include('Activos.Caracteristicas.CaracteristicasDestroy')
    ...
    <div class="card">
        <div class="card-header">
            ...
            @can('actv.caracteristicas.crear')
                <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('caracteristicasactivos.create') !!}">
                        ...
                        <tr>
                            ...
                            <td class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                    @can('actv.caracteristicas.editar')
                                        <a class="dropdown-item" href=" {{ route('caracteristicasactivos.edit', $caracteristica->id_caracteristica) }}"><i class="fa fa-edit"></i>Editar</a>
                                    @endcan
                                    @can('actv.caracteristicas.eliminar')
...
@section('scripts')
    ...
    <script>
        $('#modal-eliminar').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('.modal-body h5').text('Desea Eliminar el Subadicionales ' + nombre + ' ?') //cambia texto en el body del modal
        })
    </script>
