...
<ul class="breadcrumb-title">
    ...
    <li class="breadcrumb-item"><a href="{{ route('tiposactivos.index') }}">Tipo de Activo</a>
    </li>
...
<div class="card">
    ...
    <div class="card-block">
        ...
        <form method="POST" action=" {{ route('tiposactivos.update', $tipo->id_tipo) }}" enctype="multipart/form-data">
            @csrf @method("put")
