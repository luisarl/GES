...
@include('Activos.estados.EstadosDestroy')
    ...
    <div class="card">
        <div class="card-header">
            ...
            @can('actv.estados.crear')
                <a class="btn btn-primary float-right" title="Nuevo" href="{!! route('estadosactivos.create') !!}">
                        ...
                        <tr>
                            ...
                            <td class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                                    @can('actv.estados.editar')
                                        <a class="dropdown-item" href=" {{ route('estadosactivos.edit', $estado->id_estado) }}"><i class="fa fa-edit"></i>Editar</a>
                                    @endcan
                                    {{-- @can('actv.estados.eliminar')
                                        <a class="dropdown-item" data-id="{{ $estado->id_estado }}" data-nombre="{{ $estado->nombre_estado }}"  data-toggle="modal" data-target="#modal-eliminar" href="#!"><i class="fa fa-trash"></i>Borrar</a>
                                    @endcan --}}
                                </div>
                            </td>
                        </tr>
...
@section('scripts')
    ...
    <script>
        $('#modal-eliminar').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('.modal-body h5').text('Desea Eliminar el Estado ' + nombre + ' ?') //cambia texto en el body del modal
        })
    </script>
